 ...
 */
#define PSU_CONTROL
#define PSU_NAME "Power BTT Relay V1.2"
  ...
  //#define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    #define AUTO_POWER_E_TEMP        40 // (°C) PSU on if any extruder is over this temperature
...
// Disable axis //s immediately when they're not being stepped.
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_INDEX_LAST    120 // Index of the last background LED
