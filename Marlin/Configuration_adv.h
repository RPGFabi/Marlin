...
/**
 * Custom Connections 
 * 1. NC-Relay as Smokedetection and Emergencyshutdown on E3_DIAG_PIN PG15
 * 2. Extra Fan for Driver and MOSFET on FAN5_PIN
 * 3. PhotoOutput on E2_DIAG_PIN PG14
 * 4. Freeze on FIL_RUNOUT2_PIN (LOW = Freeze => Pullup)
*/
